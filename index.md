   ...
   <section id="cta" class="wrapper style4"> 
    <div class="inner"> 
     ...
     <ul class="actions vertical"> 
      ...
      <li><a href="http://Status.Mctalks.com/id-3878.html" class="button fit special">服务器在线状态检测(无效)</a></li>
      <li><a href="http://GF.PatyServer.xyz:8888/down/NwjtXJVg5A42" class="button fit special">服务器客户端下载(维护)</a></li>
      <li><a href="http://PatyServer.Github.io/images/Paty服务器指南.txt" class="button fit special">服务器指南下载(维护)</a></li>
